...
import com.appbasic.domain.Permission;
import com.appbasic.domain.Rol;
import com.appbasic.domain.User;
import com.appbasic.gui.GuiPanelNewUser;
import com.appbasic.gui.util.JStatusbar;
import com.appbasic.gui.PanelAccess;
import com.appbasic.gui.PanelAdminBackup;
import com.appbasic.gui.PanelAdminConfig;
import com.appbasic.gui.PanelModAdmin;
import com.appbasic.gui.PanelAdminUsers;
import com.appbasic.gui.util.PanelBasic;
import com.appbasic.gui.PanelChangePassword;
import com.appbasic.gui.PanelNewRol;
import com.appbasic.gui.PanelNewUser;
import com.appbasic.gui.PanelPresentation;
...
//            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void reloadToolbar() {
        if (toolbar != null) {
            ...
            Permission perm = app.getControl().getPermissionByName("show-admin-module");
...
//        dialog.setPreferredSize(new Dimension(w, h));
    ...
    public void showBasicPanel(PanelBasic panel, Permission perm) {
        ...
        if (user != null && app.getControl().hasPermission(user, perm)) {
            setWaitCursor();
            getSplitpane().setTopComponent(panel);
            setDefaultCursor();
        } else {
